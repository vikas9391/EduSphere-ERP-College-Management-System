...
export async function getStudentDashboardSummary(): Promise<StudentDashboardSummary> { const res = await api.get<{ data: StudentDashboardSummary }>('/student/dashboard'); return res.data.data }
...
export async function getMyAssignments(): Promise<MyAssignment[]> { const res = await api.get<{ data: MyAssignment[] }>('/student/assignments'); return res.data }
...
export async function getMyResults(): Promise<MyOverallResult> { const res = await api.get<{ data: MyOverallResult }>('/student/results'); return res.data }
...
export async function getMyTimetable(): Promise<StudentTimetable> { const res = await api.get<{ data: StudentTimetable }>('/student/timetable'); return res.data }
